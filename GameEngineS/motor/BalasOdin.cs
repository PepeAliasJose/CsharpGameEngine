...
namespace GameEngineS.motor
{
    public class BalasOdin
    {
        ...
        public BalasOdin(vector posicion, vector escala, float velocidad, float velDiferencia, bool vertical, bool xPositivo, bool yPositivo)
        {
